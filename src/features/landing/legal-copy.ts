      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Analytics and diagnostics are off until you opt in. The Privacy settings control on enabled production pages lets you accept, reject or choose them separately and change your decision later. Your preference expires after 180 days. If browser storage is unavailable, it applies only to the current page session.",
